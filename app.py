...
# diabetes_model = pickle.load(open(r"D:\Sem_4 ML_Project\saved_models\diabetes_model.sav", 'rb'))
# heart_disease_model = pickle.load(open(r"D:\Sem_4 ML_Project\saved_models\heart_disease_model.sav", 'rb'))
